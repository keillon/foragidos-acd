      ...
      <div className="flex items-center justify-center min-h-screen p-4 bg-gray-50">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>As variáveis de ambiente do Supabase não estão configuradas.</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="mb-4">
              Para usar este aplicativo, você precisa configurar as seguintes variáveis de ambiente no Vercel:
            </p>
            ...
            <p className="mb-4 text-sm text-gray-600">
              Estas variáveis devem ser configuradas no painel de controle do Vercel em Settings &gt; Environment
              Variables.
            </p>
          </CardContent>
          <CardFooter>
